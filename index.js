...
console.log(MenuElemaniOlustur("Tavuk Şiş",93,"Izgaralar"));
console.log(MenuElemaniOlustur("Tavada Balık",80,"Deniz Ürünleri"));
...
console.log(DegerledirmeEkle(degerlendirmeler, "Ali", 9, "Mükemmel bir yer"));
